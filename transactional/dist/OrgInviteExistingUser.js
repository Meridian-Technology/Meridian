...
var OrgInviteExistingUser = function (_a) {
    var orgName = _a.orgName, orgDescription = _a.orgDescription, role = _a.role, roleDisplayName = _a.roleDisplayName, inviterName = _a.inviterName, acceptUrl = _a.acceptUrl, declineUrl = _a.declineUrl;
        ...
        react_1.default.createElement(components_1.Section, { style: styles.container, className: "email-container" },
            react_1.default.createElement(components_1.Section, { style: styles.card, className: "email-content" },
                react_1.default.createElement(components_1.Section, { style: styles.content },
                    react_1.default.createElement(components_1.Text, { style: styles.title }, "Organization invitation"),
                    ...
                    react_1.default.createElement(components_1.Text, { style: styles.body },
                        react_1.default.createElement("strong", null, "What to do next")),
                    react_1.default.createElement(components_1.Text, { style: styles.body }, "Click below to accept or decline this invitation. If you accept, you'll be added to the organization immediately."),
                    react_1.default.createElement(components_1.Row, { style: { marginTop: 24 } },
                        react_1.default.createElement(components_1.Column, { style: { paddingRight: 12 } },
                            react_1.default.createElement(components_1.Button, { href: acceptUrl, style: styles.button }, "Accept invitation")),
                        react_1.default.createElement(components_1.Column, null,
                            react_1.default.createElement(components_1.Button, { href: declineUrl, style: styles.buttonSecondary }, "Decline"))),
                    react_1.default.createElement(components_1.Text, { style: styles.footer }, "This invitation will expire in 7 days. This is an automated message from Meridian."))))));
};
