...
async function uploadAsset(req, accountId, file) {
  ...
  const mime = { png: 'image/png', jpeg: 'image/jpeg', webp: 'image/webp', gif: 'image/gif' }[metadata.format];
...
module.exports = { studioUpload, listAssets, uploadAsset, validateAssetOwnership };
