...
var OrgInviteNewUser = function (_a) {
    var orgName = _a.orgName, role = _a.role, inviterName = _a.inviterName, signUpUrl = _a.signUpUrl;
    var textStyles = {
        fontSize: 16,
        lineHeight: "24px",
        color: "#414141",
                ...
                react_1.default.createElement(components_1.Section, { style: { padding: "0 20px 20px 20px" } },
                    ...
                    react_1.default.createElement(components_1.Container, { style: { padding: "0 10%", boxSizing: "border-box" } },
                        ...
                        inviterName && react_1.default.createElement(components_1.Text, { style: textStyles },
                            inviterName,
                            " invited you to join this organization on Meridian."),
                        react_1.default.createElement(components_1.Text, { style: textStyles }, "Create a free account to accept this invitation and join the organization."),
                        react_1.default.createElement(components_1.Row, { style: { marginTop: 24 } },
                            react_1.default.createElement(components_1.Button, { href: signUpUrl, style: {
                        ...
                        react_1.default.createElement(components_1.Text, { style: __assign(__assign({}, textStyles), { marginTop: 24, fontSize: 14, color: "#6b7280" }) }, "Use the same email address this invite was sent to when creating your account. This invitation will expire in 7 days.")))))));
};
