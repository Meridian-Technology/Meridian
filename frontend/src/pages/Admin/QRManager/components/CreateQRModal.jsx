...
function QRPreview({ fgColor, bgColor, dotType, cornerType, transparentBg, dataUrl, size = 180 }) {
    ...
    }, [fgColor, bgColor, dotType, cornerType, transparentBg, dataUrl, size]);

    return <div ref={containerRef} className="qr-preview-canvas" style={{ width: size, height: size }} />;
}

function CreateQRModal({ onClose, onSuccess, handleClose }) {
    ...
    const previewUrl = formData.name.trim()
        ? `${window.location.origin}/qr/${encodeURIComponent(formData.name.trim())}`
    ...
    return (
        <div className="create-qr-modal">
            ...
            <p className="create-qr-modal-subtitle">Configure where it leads, name it, and customize colors and style below.</p>
            {error && (
            ...
            <form onSubmit={handleSubmit} className="create-qr-form">
                    ...
                    <div className="create-qr-form-fields">
                        <div className="form-group">
                            ...
                            <input
                                ...
                                placeholder="e.g. poster, lobby-sign"
                                required
                                disabled={loading}
                            />
                        </div>
                        <div className="form-group">
                            ...
                            <input
                                ...
                                disabled={loading}
                            />
                            <small className="form-help">Relative (e.g. /events) or absolute URL</small>
                        </div>
                        <div className="form-group">
                ...
                <div className="modal-actions">
                    ...
                    <button type="submit" disabled={loading || !formData.name.trim() || !formData.redirectUrl.trim()}>
