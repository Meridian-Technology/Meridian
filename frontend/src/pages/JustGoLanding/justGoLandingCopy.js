...
export const JUSTGO_LANDING_COPY_KEYS = Object.freeze({
  ...
  waitlistPhoneLabel: 'landing.web.waitlist.phoneLabel',
  waitlistPhonePlaceholder: 'landing.web.waitlist.phonePlaceholder',
  ...
  waitlistPhoneRequired: 'landing.web.waitlist.phoneRequired',
