/**
 * ICU playground for Voice editor. Subset of the mobile resolver:
 * `{name}` interpolation, plural, select. Broken templates do not throw.
 */
 ...
 */
export function formatPivotCopyTemplate(template, params = {}) {
...
export function nestedTokenParams(tokens = {}) {
