...
function AnalyticsDashboard() {
    ...
    const { data: dashboardData, loading, error, refetch } = useFetch(`/dashboard/all?timeRange=${timeRange}`);
        ...
        <div className="analytics-dashboard">
            <header className="header">
                <div className="header-content">
                    ...
                    <p>Comprehensive insights into user behavior and platform performance</p>
                </div>
