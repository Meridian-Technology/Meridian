...
const StudioVerification = lazy(() => import('./pages/PlatformAdmin/PivotTenantDashboard/carousel/studio/StudioVerification'));
                            ...
                            <CacheProvider>
                                <Router>
                                    ...
                                    <Routes>
                                        ...
                                        {process.env.NODE_ENV === 'development' && <Route path="/dev/justgo-studio" element={<StudioVerification />} />}
